...
extern SimulinkPublisher<std_msgs::msg::Int16MultiArray,SL_Bus_std_msgs_Int16MultiArray> Pub_ThrusterSolver_113;
...
extern SimulinkParameterArrayGetter<real64_T,std::vector<double>> ParamGet_ThrusterSolver_146;
// For Block ThrusterSolver/Get Thruster Wrench Matrix
extern SimulinkParameterArrayGetter<real64_T,std::vector<double>> ParamGet_ThrusterSolver_126;
...
extern SimulinkParameterArrayGetter<real64_T,std::vector<double>> ParamGet_ThrusterSolver_160;
// For Block ThrusterSolver/RPM Spline Segment Cutoffs
extern SimulinkParameterArrayGetter<real64_T,std::vector<double>> ParamGet_ThrusterSolver_165;
