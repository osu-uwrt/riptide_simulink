...
SimulinkParameterArrayGetter<real64_T,std::vector<double>> ParamGet_ThrusterSolver_146;
// For Block ThrusterSolver/Get Thruster Wrench Matrix
SimulinkParameterArrayGetter<real64_T,std::vector<double>> ParamGet_ThrusterSolver_126;
...
SimulinkParameterArrayGetter<real64_T,std::vector<double>> ParamGet_ThrusterSolver_160;
// For Block ThrusterSolver/RPM Spline Segment Cutoffs
SimulinkParameterArrayGetter<real64_T,std::vector<double>> ParamGet_ThrusterSolver_165;
