...
struct B_FF_Controller_T {
  ...
  real_T Transpose[3];                 // '<S4>/Transpose'
  real_T rtb_ElementProduct_c[3];
  int64_T value[3];
  int64_T value_k[3];
  ...
  real_T rtb_TmpSignalConversionAtSFu_cv;
  int64_T value_f;
  int64_T value_g;
  int64_T value_g1;
};
...
struct DW_FF_Controller_T {
  ...
  ros_slros2_internal_block_Get_T obj_m;// '<Root>/Get Parameter'
...
//  '<S5>'   : 'FF_Controller/Calculate FF/Calculate World Frame Force and Torque/Body 2 World Rotm'
//  '<S6>'   : 'FF_Controller/Calculate FF/Calculate World Frame Force and Torque/Body Frame Force and Torque'
