...
//
#ifndef RTW_HEADER_FF_Controller_types_h_
#define RTW_HEADER_FF_Controller_types_h_
#include "rtwtypes.h"
...
// Custom Type definition for MATLABSystem: '<S10>/SinkBlock'
...
typedef struct P_FF_Controller_T_ P_FF_Controller_T;

// Forward declaration for rtModel
typedef struct tag_RTM_FF_Controller_T RT_MODEL_FF_Controller_T;

#endif                                 // RTW_HEADER_FF_Controller_types_h_
