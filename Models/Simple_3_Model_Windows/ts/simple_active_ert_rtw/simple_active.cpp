...
void simple_active::step()
{
  ...
  simple_active_B.ControlSum[0] = simple_active_B.In1_c.position.x;
  simple_active_B.ControlSum[1] = simple_active_B.In1_c.position.y;
  simple_active_B.ControlSum[2] = simple_active_B.In1_c.position.z;
  ...
  for (trueCount = 0; trueCount < 6; trueCount++) {
    simple_active_B.CurrentError[trueCount] = simple_active_B.dv[trueCount] -
      simple_active_B.ControlSum[trueCount];
  }

  // End of Sum: '<S2>/Current Error'
  ...
  ParamGet_simple_active_43.getParameter(&simple_active_B.value_cv);

  // MATLABSystem: '<Root>/Get Parameter1'
  ParamGet_simple_active_44.getParameter(&simple_active_B.value_f);
  ...
  simple_active_B.Divide = static_cast<real_T>(simple_active_B.value_cv) /
    static_cast<real_T>(simple_active_B.value_f);
  ...
  for (trueCount = 0; trueCount < 6; trueCount++) {
    ...
    simple_active_B.ControlSum[trueCount] = (static_cast<real_T>
      (simple_active_B.value[trueCount]) * simple_active_B.q *
      simple_active_P.PControl_Gain + static_cast<real_T>
      (simple_active_B.value_c[trueCount]) * simple_active_B.dv[trueCount] *
      simple_active_P.DControl_Gain) + static_cast<real_T>
      (simple_active_B.value_k[trueCount]) * simple_active_B.euler_tmp *
