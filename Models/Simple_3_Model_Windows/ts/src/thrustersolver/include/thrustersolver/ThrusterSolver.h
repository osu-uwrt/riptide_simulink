...
struct B_ThrusterSolver_T {
  ...
  char_T prmName_cv[20];
  char_T prmName_f[16];
  char_T b_zeroDelimTopic_g[16];
  char_T prmName_g[14];
  int8_T p[8];
  int8_T ipiv[8];
  real_T rtb_CurrentTime_m;
  real_T smax;
  real_T s;
  real_T Subtract;                     // '<S3>/Subtract'
  real_T ApplyOveruse;                 // '<S7>/Apply Overuse'
  real_T smax_n;
  real_T s_p;
  int64_T value_l;
  int64_T value_j;
...
struct DW_ThrusterSolver_T {
  ...
  ros_slros2_internal_block_Get_T obj_p;// '<Root>/Individual Limit2'
  ros_slros2_internal_block_Get_T obj_e;// '<Root>/Individual Limit1'
  ros_slros2_internal_block_Get_T obj_pl;// '<Root>/Individual Limit'
...
struct P_ThrusterSolver_T_ {
  ...
  real_T NoForce_Value[8];             // Expression: [0;0;0;0;0;0;0;0]
...
//  '<S15>'  : 'ThrusterSolver/Thruster Solver/Check Fully Actuated'
//  '<S16>'  : 'ThrusterSolver/Thruster Solver/MATLAB Function'
