...
importedData.robot.thrusters.VUSDir = [0.0, -0.785, 1.571];
importedData.robot.thrusters.VUPPos = [-0.14, 0.328, 0.141];
importedData.robot.thrusters.VUPDir = [0.0, -0.785, -1.571];
importedData.robot.thrusters.HUSPos = [-0.134, -0.369, 0.242];
importedData.robot.thrusters.HUSDir = [0.0, 0.0, 0.0];
importedData.robot.thrusters.HUPPos = [-0.134, 0.438, 0.242];
importedData.robot.thrusters.HUPDir = [0.0, 0.0, 0.0];
importedData.robot.thrusters.HLSPos = [-0.14, -0.26, -0.141];
importedData.robot.thrusters.HLSDir = [0.0, 0.785, 1.571];
importedData.robot.thrusters.HLPPos = [-0.14, 0.328, -0.141];
importedData.robot.thrusters.HLPDir = [0.0, 0.785, -1.571];
...
importedData.robot.coefficients.roll = [0.0, 0.0, 0];
importedData.robot.coefficients.pitch = [0.0, 0.0, 0];
importedData.robot.coefficients.yaw = [0.0, 0.0, 0];
importedData.robot.coefficients.x = [0.0, 0.0, 0];
importedData.robot.coefficients.y = [0.0, 0.0, 0];
importedData.robot.coefficients.z = [0.0, 0.0, 0];
